"""
Django settings for DynamicWebSystems project.
...
SECRET_KEY = 'x(nz!=xk1at1e9by-^jmuiyc7d!p%$v7%s=8!-6=7&jxo0^+f0'
...
WSGI_APPLICATION = 'DynamicWebSystems.wsgi.application'
